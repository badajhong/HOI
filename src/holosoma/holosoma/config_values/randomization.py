...
from holosoma.config_values.wbt.g1.randomization import g1_29dof_wbt_randomization, g1_29dof_wbt_randomization_w_object, g1_29dof_wbt_randomization_w_object_multi_res
...
DEFAULTS = {
    ...
    "g1_29dof_wbt_w_object_multi_res": g1_29dof_wbt_randomization_w_object_multi_res,
}
